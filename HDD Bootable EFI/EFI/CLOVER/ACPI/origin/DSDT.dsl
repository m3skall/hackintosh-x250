 ...
 *
 * Disassembly of DSDT.aml, Sun May 19 14:48:35 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000F398 (62360)
 *     Revision         0x02
 *     Checksum         0x0A
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "TP-N10  "
 ...
 */
DefinitionBlock ("", "DSDT", 2, "LENOVO", "TP-N10  ", 0x00001350)
{
    /*
    ...
    External (BATC, DeviceObj)    // (from opcode)
            ...
            Device (LPC)
            {
                ...
                Device (MOU)
                {
                    ...
                    Method (MHID, 0, NotSerialized)
                    {
                        ...
                        ElseIf (NFCD)
                        {
                            Store (0x4600AE30, _HID)
                        }
                        Else
                        {
                            Store (0x4500AE30, _HID)
                        }
                    }
                }
                ...
                Device (VID)
                {
                    ...
                    Method (GPON, 1, NotSerialized)
                    {
                        If (ISOP ())
                        {
                            ...
                            ElseIf (LNotEqual (VSID, 0x222617AA))
                            {
                                VHYB (0x04, Zero)
                            }
            ...
            Device (XHCI)
            {
                ...
                Method (_PS0, 0, Serialized)  // _PS0: Power State 0
                {
                    ...
                    ElseIf (LEqual (PCHV (), LPTL))
                    {
                        ...
                        {
                            Store (0xFEAF0000, MBA1)
                            Store (One, Local6)
                        }

                        Store (Zero, Local3)
                        Store (PDBM, Local4)
                        If (LEqual (And (Local4, 0xFF), Zero))
                        {
                            Store (PDBM, Local0)
                    ...
                    ElseIf (LEqual (PCHV (), LPTL))
                    {
                        ...
                        If (LEqual (Local5, 0x03))
                        {
                            ...
                            {
                                Store (One, WPR1)
                                While (LEqual (And (A171, 0x04), Zero)){}
                                Store (0x7F, A171)
                            }
                            ...
                            {
                                Store (One, WPR2)
                                While (LEqual (And (A172, 0x04), Zero)){}
                                Store (0x7F, A172)
                            }
                            ...
                            {
                                Store (One, WPR3)
                                While (LEqual (And (A173, 0x04), Zero)){}
                                Store (0x7F, A173)
                            }
                            ...
                            {
                                Store (One, WPR4)
                                While (LEqual (And (A174, 0x04), Zero)){}
                                Store (0x7F, A174)
                            }
